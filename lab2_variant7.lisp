;; Лабораторна робота 2. Рекурсія — Варіант 7
;; Автор: Савєльєв Олександр, група: ___
;; Дата: 2025
...
;;; ------------------------------------------------------------
;;; 1) merge-lists-pairs
;;; Формує послідовні пари з двох списків (за зразком у завданні).
;;; Рекурсивна реалізація без циклів і без HOF.
;;; ------------------------------------------------------------
...
;;; ------------------------------------------------------------
;;; 2) sublist-after-p
;;; Перевіряє, чи після вказаного атома elem у списку lst
;;; знаходиться підсписок sublst (як безпосереднє продовження).
;;; ------------------------------------------------------------
...
;;; ------------------------------------------------------------
;;; Модульні тести (простий фреймворк з форматованим виводом)
;;; ------------------------------------------------------------
